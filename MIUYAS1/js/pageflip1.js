		...
		mouse.y = event.clientY - book.offsetTop;
			...
			if (Math.abs(mouse.x) < PAGE_WIDTH ) {
				...
				$.each(datasure,function(index,item){
					console.log(page);
					if(page==index&&page<8) {
						$("#pageflip-canvas").css("width","1396px");
						...
						var width1=$("#pageflip-canvas").css("width");
						var width2=width1.replace("px","");
						var width3=width2/2+"px";

						$("#pageflip-canvas").css("width",width3);
					}
